...
function App() {
    ...
    if (loading) return <div className="min-h-screen flex items-center justify-center font-bold text-xl">Loading StellarHub...</div>;

    return (
        // Poore app ko GoogleOAuthProvider se wrap karein
